...
Configure your agents to use the secret token:

++++
<div class="tabs">
  <div role="tablist" aria-label="Sample Tabs">
    <button class="button-style" role="tab" aria-selected="true" aria-controls="panel-1" id="tab-1" tabindex="0">
      Java
    </button>
    <button class="button-style" role="tab" aria-selected="false" aria-controls="panel-2" id="tab-2" tabindex="-1">
      Ruby
    </button>
    <button class="button-style" role="tab" aria-selected="false" aria-controls="panel-3" id="tab-3" tabindex="-1">
      Go
    </button>
    <button class="button-style" role="tab" aria-selected="false" aria-controls="panel-4" id="tab-4" tabindex="-1">
      Python
    </button>
    <button class="button-style" role="tab" aria-selected="false" aria-controls="panel-5" id="tab-5" tabindex="-1">
      Node.js
    </button>
  </div>
  <div class="content" id="panel-1" role="tabpanel" tabindex="0" aria-labelledby="tab-1">
++++

include::./test-asciidoc/java1.asciidoc[]

++++
  <hr>
  </div>
  <div class="content" id="panel-2" role="tabpanel" tabindex="0" aria-labelledby="tab-2" hidden>
++++

include::./test-asciidoc/ruby1.asciidoc[]

++++
  <hr>
  </div>
  <div class="content" id="panel-3" role="tabpanel" tabindex="0" aria-labelledby="tab-3" hidden>
++++

include::./test-asciidoc/go1.asciidoc[]
...
.button-style[aria-selected="true"]{
