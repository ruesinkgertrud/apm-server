...
Source maps::
The APM Server source map upload endpoint is not compatible with {agent}.
Source maps must be uploaded directly to {es}. See <<apm-integration-sourcemaps>> for more information.
